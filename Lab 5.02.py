...
#creat dict to store keyvalue pairs
word_dict = {}
...
while True:
    userchoice = input("what word would u like to know the freuquency of ")
    if userchoice in word_dict:
        print(f"{userchoice} appears {word_dict[userchoice]} time(s)")
    elif userchoice == 'q':
        break
    else:
